	...
	public void actionPerformed( ActionEvent ev ){
		...
		if ( o == b_moveMoney )
		{
			try{
				...
				if(result == 0) JOptionPane.showInternalMessageDialog(null, "이체성공");
				else if(result == -1) JOptionPane.showInternalMessageDialog(null, "이체실패");
				...
				JOptionPane.showMessageDialog(frame,"이체하는 도중 에러가 발생하였습니다!! 이를 워쩌 망했부렀어유");
				return;
			}
